				...
				<ul>
					<?php
						foreach ($slides as $post):
							...
							$img_src     = ( $image || ($use_image && $image ) ) ? $image : '/wp-content/themes/flatten/images/transparent.png';
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'select',
					'options' => array(
						'big_base'        => __('Big Base Color'),
						'big_link'        => __('Big Link Color'),
						'gray_box_right'  => __('Gray Box Color Right Align'),
						'gray_box'        => __('Gray Box Color Left Align'),
